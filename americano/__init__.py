...
# This module implements a parser and evaluator for a restricted subset of JavaScript.
#
# It is implemented using a variation of a Crockford TDOP style Pratt parser modified to
# support creation of an evaluable node tree on parse.
#
...
def parse(expression, global_context={}):
    """
    ...
    In addition, the following syntax constructs are supported:
     ...
     Example:
         ...
         parsed.eval({'var': 1})
    """
    return Parser(expression).root(global_context)
